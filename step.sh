...
echo "---Save video---"
curl -u "$browserstack_username":"$browserstack_access_key" -X GET "https://www.browserstack.com/s3-upload/bs-video-logs-usw/s3-us-west-1/$session_id/video-$session_id.mp4" > $BITRISE_DEPLOY_DIR/video.mp4
